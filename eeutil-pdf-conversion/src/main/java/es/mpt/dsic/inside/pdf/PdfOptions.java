...
public class PdfOptions {
	...
	// Indica el desplazamiento, con respecto al borde de la izquierda (si es positivo), o el borde de la derecha (si es negativo)
	// en que quiere imprimirse el número de página.
	private Float pageSepHoriz;
	// Indica el desplazamiento, con respecto al borde de abajo (si es positivo), o el borde arriba (si es negativo)
	// en que quiere imprimirse el número de página.
