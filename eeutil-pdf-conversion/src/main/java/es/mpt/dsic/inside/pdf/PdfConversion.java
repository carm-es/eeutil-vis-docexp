...
public class PdfConversion {
	...
	private static final String REDUCED_PREFIX = "reduced";
	  ...
	  * @param baos para construir el PdfReader necesario para que no se pierdan los campos de las plantillas
	  ...
	  * @param positionX Coordenada X de la posici�n absoluta donde vamos a estampar cada p�gina del documento.
	  * @param positionY Coordenada Y de la posici�n absoluta donde vamos a estampar cada p�gina del documento.
	 * @throws IOException 
	 * @throws DocumentException 
	 ...
	 public void addPdfScaled   (Document doc, 
			 							...
			 							String salidaPath,
			 							PdfWriter pw, 
			 							PdfReader readerEntrada,
			 							PdfOptions options,
			 							PageNumberInfo pageNumberInfo
			 							) throws PdfConversionException, DocumentException, IOException {
				...
				for (int i=1; i<=n; i++) {
					...
					if (options.isPrintPageNumbers()) {
			            ...
			            ColumnText.showTextAligned(
			            		pw.getDirectContent(), Element.ALIGN_CENTER,
			                    new Phrase(String.format("page %d of %d", actualPage, totalPages)),
			                    x, y, 0);
