...
public class ConfigLoaderListener implements ServletContextListener {
	...
	{
		Properties props = EeutilApplicationDataConfig.loadProperties(EeutilApplicationDataConfig.APP_PROPERTIES_FILE);
		
		// Si no encuentra la variable la toma del parámetro establecido en el web.xml
		String configPathProperty = System.getProperty(props.getProperty(EeutilApplicationDataConfig.APPLICATION_NAME_PROPERTY) + "." + EeutilConfigPath.CONFIG_PATH_VAR);
