...
public class MiscUtil {
	...
	/**
	 * Decodifica un String en un array de bytes, dependiendo del encoding que se le pasa por parámetro hace una cosa u otra
	 * @param original
	 * @param encoding
	 * @return
	 * @throws CharacterCodingException 
	 */
	public static byte[] decodeByEncoding (String original, String encoding) throws CharacterCodingException {
		byte[] decod = null;
	 ...
	 * 
	 * Utilizado para la validaci�n del SIP recibido en el servicio
	 * SipBusinessService.
	 * 
	 * @param algoritm
	 *            String
	...
	public static void main (String[] args) {
		System.out.println(meteComillasXPath(meteAsteriscoXPath("//[@Id=CONTENT-1c5d50a7-f5e1-4171-9d10-d9c2909fcb72]")));
	}
}
