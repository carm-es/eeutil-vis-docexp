...
public class MimeUtil {
	...
	/**
	 * Obtiene el tipo mime en base al contenido de un fichero. Si no se puede obtener con ninguna utilidad devuelve el mime por defecto.
	 * @param data bytes de los datos.
	 * @return El mime obtenido con la utilidad, si no se detecta ninguno devuelve el mime por defecto.
	 */
	public static String getMimeNotNull (byte[] data) {
		...
		if (ZIP_MIME_1.equalsIgnoreCase(mimeType) || ZIP_MIME_2.equalsIgnoreCase(mimeType) || WORD_EXCEL_97_MIME.equalsIgnoreCase(mimeType)) {	
	 ...
	 * @param data
	 * @return null si no se detecta el mime. 
	 * @throws  
	 */
