...
public class FileUtil {
	...
	/**
	 * Método para generar un nombre único de fichero En principio será el
	 * milisegundo actual más el identificador de thread. Si ese nombre
	 * coincide con el último que se generó, entonces se le añade un sufijo.
	 * 
	 * @return
	 */
	...
	/**
	 * Devuelve un nombre de fichero aleatorio en el directorio temporal, según
	 * el patrón: currentTimeMillis () + id-thread-actual.
	 * 
	 * @return
	 */
	...
	/**
	 * Devuelve un nombre de fichero aleatorio en el directorio temporal, según
	 * el patrón: prefix + uniqueName().
	 * 
	 * @param prefix
	 *            Si es nulo, no se mete en el nombre.
	 * @return
	 */
	public static String createFilePath(String prefix) {
		...
		/*
		 * String s = getTmpDir() + System.getProperty("file.separator") +
	...
	public static ZipFile createTempZipFile(byte[] bytesFile)
			throws IOException {
		FileOutputStream fout = null;
		try {
			String tmpDir = getTmpDir();
			String tmpFilePath = tmpDir + System.getProperty("file.separator")
	...
	/**
	 * Obtiene una lista de los ficheros con una extensión dentro de un
	 * directorio. Si el directorio no se puede acceder, no existe o no contiene
	 * ficheros devuelve una lista vacía.
	 * 
	 * @param f
	 *            Directorio donde se desea buscar
	 * @param extension
	 ...
	 * @throws IOException 
	 */
	public static String createFilePath(String prefix, byte[] contenido, String suffix) throws IOException {
		FileOutputStream fos = null;
		String inputPathFile = null;
		try {
