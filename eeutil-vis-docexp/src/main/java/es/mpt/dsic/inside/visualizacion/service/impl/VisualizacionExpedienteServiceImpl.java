...
public class VisualizacionExpedienteServiceImpl implements VisualizacionService {
	...
	protected final static Log logger = LogFactory
			.getLog(VisualizacionExpedienteServiceImpl.class);
	...
	public DocumentoContenido doVisualizable(Item item,
		...
		try {
			...
			indexVisualizadorAdder.setTitle(indexVisualizadorAdder
					.getDefaulTittle());
			indexVisualizadorAdder.setNameColumnsContent(indexVisualizadorAdder
					.getDefaultColumnsContent());
			...
			if (rutaLogo != null
				...
				pdfResult = cabeceraAdder.addCabecera(pdfResult, rutaLogo,
						tExpedienteElectronico + ": "
								+ visItems.get(0).getNombre(), tDocIndice,
