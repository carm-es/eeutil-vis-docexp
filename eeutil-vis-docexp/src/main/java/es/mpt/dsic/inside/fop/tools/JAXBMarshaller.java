...
public class JAXBMarshaller {
	 ...
	 * 
	 * @param object
	 *            Objeto java a convertir.
	 * @param clase
	 *            Class java para saber el tipo.
	 * @return String con el XML equivalente.
	 * @throws JAXBException
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public <T> String marshallRootElement(T object, Class<T> clase, boolean omitDeclararion) throws JAXBException {
