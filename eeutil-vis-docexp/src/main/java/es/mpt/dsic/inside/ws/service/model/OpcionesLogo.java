...
@XmlType(name = "opcionesLogo", propOrder = { "estamparLogo", "estamparNombreOrganismo", "listaCadenasNombreOrganismo", "posicion", "estamparPie", "textoPie"})
public class OpcionesLogo {
	...
	public void setListaCadenasNombreOrganismo(
			ListaCadenas listaCadenasNombreOrganismo) {
