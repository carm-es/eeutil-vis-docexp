...
public class EeUtilVisDocExpUserNameTokenServiceImpl implements EeUtilVisDocExpUserNameTokenService {

	protected final static Log logger = LogFactory
			.getLog(EeUtilVisDocExpUserNameTokenServiceImpl.class);
	...
	@Override
	public SalidaVisualizacion visualizar(Item item,
			OpcionesVisualizacion opciones) throws InSideException {
		return visualizarService.visualizar(credentialUtil
				.getCredentialEeutilUserToken(wsContext), item, opciones);
	}

	@Override
	public SalidaVisualizacion visualizarContenidoOriginal(
			Item item) throws InSideException {
		return visualizarService.visualizarContenidoOriginal(credentialUtil
				.getCredentialEeutilUserToken(wsContext), item);
	}
	...
	public SalidaVisualizacion visualizarDocumentoConPlantilla(
		...
		return visualizarService.visualizarDocumentoConPlantilla(credentialUtil
				.getCredentialEeutilUserToken(wsContext), docEniAdicionales, plantilla);
	}
	...
	public List<Plantilla> asociarPlantilla(
		...
		return visualizarService.asociarPlantilla(credentialUtil
				.getCredentialEeutilUserToken(wsContext), idPlantilla, plantilla);
	}

	@Override
	public List<Plantilla> eliminarPlantilla(
			String idPlantilla) throws InSideException {
		return visualizarService.eliminarPlantilla(credentialUtil
				.getCredentialEeutilUserToken(wsContext), idPlantilla);
	}
