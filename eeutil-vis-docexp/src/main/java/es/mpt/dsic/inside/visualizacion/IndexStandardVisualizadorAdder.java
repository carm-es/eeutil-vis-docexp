...
public class IndexStandardVisualizadorAdder {
	...
	protected void printIndex (List<VisualizacionItem> listaItems, Document doc, PdfWriter pw) throws DocumentException{
		...
		for (int i=1; i < listaItems.size(); i++) {
			...
			tableContenido.addCell(createCeldaDescripcionContenido(visItem.marcadoresToString(true) + " - " + visItem.getNombre(), visItem.getProfundidad(), font, Element.ALIGN_LEFT));
	...
	protected void printMoreData (List<VisualizacionItem> listaItems, Document doc, PdfWriter pw) throws DocumentException{
		...
		for (int i=1; i < listaItems.size(); i++) {
			...
			//tableContenido.addCell(createCeldaDescripcionContenido(visItem.marcadoresToString(true) + " - " + visItem.getNombre(), visItem.getProfundidad(), font));
	...
	private PdfPCell createCeldaDescripcionContenido (String texto, int profundidad, Font font, int alignment) {
	...
	public void setDefaultColumnsContentDocument(
			String[] defaultColumnsContentDocument) {
