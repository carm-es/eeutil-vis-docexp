...
public class ConvertDataInside {
	...
	public static Map<String, String> convertRolesInside(Roles data, CredencialEeutil eeutilCredential) {
		...
		if (eeutilCredential != null
			&& StringUtils.isNotEmpty(eeutilCredential.getAplicacion())) {
			retorno.put("EEUTIL_IDENTIFICADOR", eeutilCredential.getAplicacion());
		}
		if (eeutilCredential != null
			&& StringUtils.isNotEmpty(eeutilCredential.getPassword())) {
