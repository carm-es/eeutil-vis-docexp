...
public class EeutilAplicacion implements Serializable{
	...
	public String toString() {
		return "EeutilAplicacion [idaplicacion=" + idaplicacion + ", password="
		+ password + ", descripcion=" + descripcion + ", activa="
		+ activa + ", tramitar=" + tramitar + ", sello=" + sello
		+ ", firma=" + firma + ", propiedades=" + propiedades + "]";
	}
	/**
	 * @return the unidad
	 */
