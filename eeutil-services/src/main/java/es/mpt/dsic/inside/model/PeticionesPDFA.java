...
public class PeticionesPDFA implements Serializable {
	...
	@Id
	@TableGenerator(name = "GeneradorPk_Peticiones_PDFA", table = "GeneradorClaves", pkColumnName = "GenName", valueColumnName = "GenValue", pkColumnValue = "peticiones_pdfa", allocationSize = 1)
