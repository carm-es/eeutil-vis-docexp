...
public interface EeutilUsuarioService {
	...
	ResultadoBusqueda<UsuarioObject> getUsuarios(String app, FilterPageRequest filterEeutil) throws InsideWSException;
	...
	UsuarioObject altaUsuario(String app, UsuarioObject usuario, String role) throws InsideWSException;
	...
	void borrarUnidadUsuario(String nifUsuario, String codigoUnidadOrganica, String numeroProcedimiento)
