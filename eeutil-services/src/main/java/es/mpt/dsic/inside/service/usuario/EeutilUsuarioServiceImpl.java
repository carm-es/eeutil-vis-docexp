...
public class EeutilUsuarioServiceImpl implements EeutilUsuarioService {
	...
	private void configureInside(String url) {
		...
		outProps.put(WSHandlerConstants.USER, propertiesSecurity.getProperty("WSHandlerConstants.USER"));
	...
	@Override
	public ResultadoBusqueda<UsuarioObject> getUsuarios(String app, FilterPageRequest filterEeutil) throws InsideWSException {
		ResultadoBusqueda<UsuarioObject> retorno = new ResultadoBusqueda<UsuarioObject>();
		if (app.equals("Inside") && configureInside()) {
			es.mpt.dsic.eeutil.inside.admin.model.FilterPageRequest filter = new es.mpt.dsic.eeutil.inside.admin.model.FilterPageRequest();
	...
	@Override
	public List<ProcedimientoObject> getListaProcedimientos(String nifUsuario) throws InsideWSException {
	...
	@Override
	public void borrarUnidadUsuario(String nifUsuario, String codigoUnidadOrganica, String numeroProcedimiento)
	...
	@Override
	public UsuarioObject altaUsuario(String app, UsuarioObject usuario,
			String role) throws InsideWSException {
		UsuarioObject retorno = null;
		if (app.equals("Inside") && configureInside()) {
			Usuario user = new Usuario();
			user.setNif(usuario.getIdentificador());
