...
public class EeutilPeticion implements Serializable {
	...
	@Id
	@TableGenerator(name = "GeneradorPk_Peticion", table = "GeneradorClaves", pkColumnName = "GenName", valueColumnName = "GenValue", pkColumnValue = "peticiones", allocationSize = 1)
