...
public class EeutilAplicacionOperacion implements Serializable {
	...
	@Id
	@TableGenerator(name = "GeneradorPk_Aplicacion_Operacion", table = "GeneradorClaves", pkColumnName = "GenName", valueColumnName = "GenValue", pkColumnValue = "aplicacion_operacion", allocationSize = 1)
