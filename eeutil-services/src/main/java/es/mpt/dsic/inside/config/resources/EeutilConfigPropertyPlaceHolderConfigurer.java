...
public class EeutilConfigPropertyPlaceHolderConfigurer extends PropertyPlaceholderConfigurer {
	...
	public EeutilConfigPropertyPlaceHolderConfigurer() {
		...
		// Por defecto, permite que haya placeholders sin resolver (para que se resuelvan mediante otros)
	...
	/**
	 * Establece el ResourceLoader que se utilizara como <i>fallback</i> para encontrar
	 * los recursos si no se encuentran mediante el ConfigResourceLoader
	 * 
