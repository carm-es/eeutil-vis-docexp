...
public class EeutilConfigResourceLoader implements ResourceLoader {
	...
	/**
	 * Constructor. Utiliza un DefaultResourceLoader para encontrar los recursos que no
	 * encuentre en configuracion
	 */
	...
	/**
	 * Constructor. Utiliza el resourceLoader indicado para encontrar los recursos que no
	 * encuentre en configuracion
	 *
	 * @param resourceLoader ResourceLoader para encontrar los recursos que no encuentre
	 *        en configuracion
	 */
	...
	/**
	 * Obtiene el recurso especificado a partir del directorio de configuracion, o
	 * utilizando el ResourceLoader indicado en el constructor si no lo encuentra.
	 *
	...
	public Resource getResource(String location) {
		...
		if ((EeutilApplicationDataConfig.APLICACION != null) && !EeutilApplicationDataConfig.APLICACION.equals("sin-definir")) {
		...
		logger.info("Usando configuracion " + location + " del fichero "
				+ searchedFile.getAbsolutePath());
