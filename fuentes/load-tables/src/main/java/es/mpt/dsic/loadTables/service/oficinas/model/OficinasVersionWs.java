...
/**
 * <p>
 * Clase Java para OficinasVersionWs complex type.
 * 
 * <p>
...
@XmlType(name = "OficinasVersionWs",
    propOrder = {"usuario", "clave", "formatoFichero", "tipoConsulta", "codigo",
        "nivelAdministracion", "estados", "comunidad", "provincia", "codigoUnidad", "versionUnidad",
...
public class OficinasVersionWs {
  ...
  /**
   * Obtiene el valor de la propiedad versionUnidad.
   * 
   * @return possible object is {@link String }
   * 
   */
  ...
  /**
   * Define el valor de la propiedad versionUnidad.
   * 
   * @param value allowed object is {@link String }
   * 
   */
