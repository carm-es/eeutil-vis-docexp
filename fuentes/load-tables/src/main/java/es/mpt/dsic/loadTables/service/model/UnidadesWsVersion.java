...
/**
 * <p>
 * Clase Java para UnidadesWsVersion complex type.
 * 
 * <p>
...
@XmlType(name = "UnidadesWsVersion",
    propOrder = {"usuario", "clave", "formatoFichero", "tipoConsulta", "codigo", "version",
        "unidadesDependientes", "nivelAdministracion", "nivelJerarquico", "estados", "comunidad",
        "provincia", "servicios", "fechaInicio", "fechaFin"})
