...
public class UtilidadesTestPdfConversionIgae implements IPruebaTraza {
  protected static final Log logger = LogFactory.getLog(UtilidadesTestPdfConversionIgae.class);
  ...
  public String testTrazaImp() {
    ...
    logger.error("Is implementation SLF4JLocationAwareLog " + bImpSLF4JLocationAwareLog
        ...
        + " Verificacion de que la traza en eeutil-pdf-conversion-igae es correcta");
