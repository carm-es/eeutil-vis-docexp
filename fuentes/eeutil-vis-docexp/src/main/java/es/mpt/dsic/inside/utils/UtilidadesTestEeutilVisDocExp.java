 ...
 *
 */
public class UtilidadesTestEeutilVisDocExp implements IPruebaTraza {
  protected static final Log logger = LogFactory.getLog(UtilidadesTestEeutilVisDocExp.class);
  ...
  public String testTrazaImp() {
    ...
    logger.error("Is implementation SLF4JLocationAwareLog " + bImpSLF4JLocationAwareLog
        ...
        + " Verificacion de que la traza en eeutil-vis-docexp es correcta");
