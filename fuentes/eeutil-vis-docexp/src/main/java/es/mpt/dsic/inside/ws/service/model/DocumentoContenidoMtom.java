...
@XmlType(name = "documentoContenidoMtom", propOrder = {"bytesDocumento", "mimeDocumento"})

public class DocumentoContenidoMtom extends DataWsEntradaBase implements Serializable, IMDCAble {
  ...
  private DataHandler bytesDocumento;
  @XmlElement(required = true, name = "mimeDocumento")
  private String mimeDocumento;

  public DataHandler getBytesDocumento() {
    return bytesDocumento;
  }

  public void setBytesDocumento(DataHandler bytesDocumento) {
