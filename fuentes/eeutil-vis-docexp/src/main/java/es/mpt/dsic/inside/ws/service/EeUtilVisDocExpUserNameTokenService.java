...
public interface EeUtilVisDocExpUserNameTokenService {
  ...
  public List<Plantilla> asociarPlantilla(
      @WebParam(name = "idPlantilla")
      @XmlElement(required = true, name = "idPlantilla") String idPlantilla,
      @WebParam(name = "plantillaBytes")
      @XmlElement(required = true, name = "plantillaBytes") byte[] plantilla)
      throws InSideException;

  @WebMethod(operationName = "eliminarPlantilla", action = "urn:eliminarPlantilla")
  @WebResult(name = "listaPlantillas", partName = "listaPlantillas")
  public List<Plantilla> eliminarPlantilla(@WebParam(name = "idPlantilla")
  @XmlElement(required = true, name = "idPlantilla") String idPlantilla) throws InSideException;
  ...
  public SalidaVisualizacion visualizarDocumentoConPlantilla(
      ...
      @WebParam(name = "plantilla")
      @XmlElement(required = true, name = "plantilla") String plantilla) throws InSideException;
}
