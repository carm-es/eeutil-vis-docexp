...
public interface AfirmaService {
	...
	ResultadoValidacionInfoAfirma validarFirma(String aplicacion,
			String firmaElectronica, String datos, String hash,
			String algoritmo, String tipoFirma);

	ResultadoValidarCertificadoAfirma validarCertificado(String aplicacion,
			String certificado, Boolean infAmpliada);

	InformacionFirmaAfirma obtenerInformacionFirma(String aplicacion,
	...
	ResultadoAmpliarFirmaAfirma ampliarFirma(String aplicacion, byte[] sign,
			ConfiguracionAmpliarFirmaAfirma configuracion)
			throws AfirmaException;

	String obtenerTipoFirmaDss(String aplicacion, byte[] firma, byte[] content)
			throws AfirmaException;

	ResultadoValidacionFirmaFormatoAAfirma validarFirmaFormatoA(
