...
public class CodigosError {
	...
	public static String MSJ_0001 = "Se ha procesado la firma y el formato de la misma no es un formato valido";
	
	public static String COD_0002 = "COD_0002";
	public static String MSJ_0002 = "El procesamiento de firmas XMLDSig Enveloping no está implementado";
	
	public static String COD_0003 = "COD_0003";
	public static String MSJ_0003 = "El servicio DSS de Afirma no reconoce la firma como un formato valido";
	...
	public static String MSJ_0005 = "El servicio DSS de Afirma no ha podido realizar la siguiente operaci�n de ampliaci�n de firma: ";

	public static String COD_0006 = "COD_0006";
	public static String MSJ_0006 = "El servicio DSS de Afirma no reconoce el formato de firma al que se desea ampliar para la operaci�n: ";

	public static String COD_0007 = "COD_0007";
	public static String MSJ_0007 = "El servicio DSS de Afirma no encuentra el formato de firma al que se desea ampliar para la operaci�n: ";
	...
	public static String MSJ_0009 = "No se ha podido crear un procesador para la firma. Por favor, compruebe que el formato de la firma se corresponda con uno de los reconocidos.";
