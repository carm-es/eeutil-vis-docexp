...
public class XMLEnvelopingDSSSignerProcessor extends DSSSignerProcessor{
	...
	public ContenidoFirmado getSignedData(ResponseBaseType verifyResponse, final byte[] sign) throws ContentNotExtractedException {
		...
		try{
			...
			//<ds:Object Encoding="http://www.w3.org/2000/09/xmldsig#base64" Id="Object-d294d524-d53a-4030-9386-d91d7269732d" MimeType="application/pdf">
			...
			// Este nodo contendra el documento en b64 cuando el atributo encoding lo marque y cuando el mymetipe no sea "hash/algo".		
