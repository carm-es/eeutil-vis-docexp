...
public abstract class DSSSignerProcessor {
	...
	protected static afirmaws.services.dss.oasis.names.tc.dss._1_0.core.schema.ObjectFactory of_oasis_core = new afirmaws.services.dss.oasis.names.tc.dss._1_0.core.schema.ObjectFactory ();
	protected static afirmaws.services.dss.oasis.names.tc.saml._1_0.assertion.ObjectFactory of_oasis_assertion = new afirmaws.services.dss.oasis.names.tc.saml._1_0.assertion.ObjectFactory ();
	protected static afirmaws.services.dss.oasis.names.tc.dss._1_0.profiles.verificationreport.schema.ObjectFactory of_oasis_profile_verificationreport = new afirmaws.services.dss.oasis.names.tc.dss._1_0.profiles.verificationreport.schema.ObjectFactory();
	protected static afirmaws.services.dss.afirma.dss._1_0.profile.xss.schema.ObjectFactory of_afirma_profile = new afirmaws.services.dss.afirma.dss._1_0.profile.xss.schema.ObjectFactory();
	 ...
	 * @param sign Firma
	 */
	public abstract void fillSignatureObjectAndInputDocuments (VerifyRequest vf, final byte sign[], final byte[] content);
	 ...
	 * @return Objeto que define la petici�n del servicio
	 */
	public VerifyRequest buildVerifyRequestToUpgrade (String idAplicacion, byte sign[], ConfiguracionAmpliarFirmaAfirma configuracion, byte[] content) {
		VerifyRequest vf = of_oasis_core.createVerifyRequest();
	 ...
	 * @return Par�metros opcionales
	 */
	public static AnyType buildOptionalInputsToUpgrade (String idAplicacion, ArrayList<byte[]> targetSignersCerts, 
