	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		try {
			if (qName.equals(Constantes.ETIQUETA_OFICINA)) {
				...
				logger.debug("Nueva Oficina:" + organismo.getDatosIdentificativos().getUnidadOrganica().getCodigo());
			...
			if (value != null && !"".equals(value.toString().trim())) {
				...
				//inicializamoos valores que deben ir informados para poder meterlos en la tabla de unidadorganica
