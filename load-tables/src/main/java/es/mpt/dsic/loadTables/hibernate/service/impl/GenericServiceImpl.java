...
public abstract class GenericServiceImpl<T extends Entidad> implements
		GenericService<T> {
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.service.GenericService#getGenericDao
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.service.GenericService#setGenericDao
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.service.GenericService#persist
	 * (java.lang.Class)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.service.GenericService#saveOrUpdate
	 * (java.lang.Class)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see es.mpt.dsic.loadTables.hibernate.service.GenericService#
	 * saveOrUpdateList (java.lang.Class)
	 */
	@Override
	 ...
	 * 
	 * @see es.mpt.dsic.loadTables.hibernate.service.GenericService#
	 * saveOrUpdateListFlush (java.lang.Class)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.service.GenericService#delete
	 * (java.lang.Class)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.service.GenericService#merge(
	 * java.lang.Class)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.service.GenericService#findById
	...
	public List<T> findById(List<T> findInstances) {
		...
		try {
			...
			for (T findInstance : findInstances) {
				retorno.add(getGenericDao()
					.findById(getClavePrimaria(findInstance), session));
			}
			return retorno;
		} finally {
			session.close();
	...
	@Override
	public List<T> findByCriterias(final int firstResult,
			final int maxResults, Class<T> entity, List<Criterion> criterios) {
		Session session = sessionFactory.openSession();
		try {
