...
public abstract class GenericDAOImpl<T extends Entidad> implements
		GenericDAO<T> {
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.dao.GenericDAO#persist(java.lang
	 * .Class)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.dao.GenericDAO#saveOrUpdate(java
	 * .lang.Class)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.dao.GenericDAO#delete(java.lang
	 * .Class)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.dao.GenericDAO#merge(java.lang
	 * .Class)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * es.mpt.dsic.loadTables.hibernate.dao.GenericDAO#findById(java.
	...
	public List<T> findByCriterias(final int firstResult,
			final int maxResults, Class<T> entity, List<Criterion> criterios, Session session) {
		Criteria crit = session.createCriteria(getEntityClass(entity));
