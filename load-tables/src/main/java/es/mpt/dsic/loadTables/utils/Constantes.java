...
public class Constantes {
	...
	public static final String ETIQUETA_CODIGO_UNIDAD_SUPERIOR_JERARQUICA_OFICINA = "tns:codUOResponsable";
	public static final String ETIQUETA_DENOMINACION_UNIDAD_SUPERIOR_JERARQUICA_OFICINA = "tns:denUOResponsable";
